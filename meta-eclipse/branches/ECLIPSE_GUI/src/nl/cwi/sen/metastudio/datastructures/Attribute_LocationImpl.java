...
extends Attribute
{
  ...
  protected aterm.ATermAppl make(aterm.AFun fun, aterm.ATerm[] i_args, aterm.ATermList annos) {
    return getDatastructuresFactory().makeAttribute_Location(fun, i_args, annos);
  }
  ...
  static public Attribute fromTerm(aterm.ATerm trm)
  {
    ...
    if (children != null) {
      Attribute tmp = getStaticDatastructuresFactory().makeAttribute_Location((Integer) children.get(0), (Integer) children.get(1));
      tmp.setTerm(trm);
      return tmp;
    }
    else {
