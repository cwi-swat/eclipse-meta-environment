...
extends Point
{
  ...
  protected aterm.ATermAppl make(aterm.AFun fun, aterm.ATerm[] i_args, aterm.ATermList annos) {
    return getDatastructuresFactory().makePoint_Default(fun, i_args, annos);
  }
  ...
  static public Point fromTerm(aterm.ATerm trm)
  {
    ...
    if (children != null) {
      Point tmp = getStaticDatastructuresFactory().makePoint_Default((Integer) children.get(0), (Integer) children.get(1));
      tmp.setTerm(trm);
      return tmp;
    }
    else {
