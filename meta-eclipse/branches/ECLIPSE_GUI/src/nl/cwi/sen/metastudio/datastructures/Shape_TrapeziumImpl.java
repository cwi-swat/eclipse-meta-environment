...
abstract public class Shape_TrapeziumImpl
extends Shape
{
  ...
  protected aterm.ATermAppl make(aterm.AFun fun, aterm.ATerm[] i_args, aterm.ATermList annos) {
    return getDatastructuresFactory().makeShape_Trapezium(fun, i_args, annos);
  }
  ...
  static public Shape fromTerm(aterm.ATerm trm)
  {
    ...
    if (children != null) {
      Shape tmp = getStaticDatastructuresFactory().makeShape_Trapezium();
      tmp.setTerm(trm);
      return tmp;
    }
    else {
