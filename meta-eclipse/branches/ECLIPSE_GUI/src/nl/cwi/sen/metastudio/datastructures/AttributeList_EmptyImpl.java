...
abstract public class AttributeList_EmptyImpl
extends AttributeList
{
  ...
  protected aterm.ATermAppl make(aterm.AFun fun, aterm.ATerm[] i_args, aterm.ATermList annos) {
    return getDatastructuresFactory().makeAttributeList_Empty(fun, i_args, annos);
  }
  ...
  static public AttributeList fromTerm(aterm.ATerm trm)
  {
    ...
    if (children != null) {
      AttributeList tmp = getStaticDatastructuresFactory().makeAttributeList_Empty();
      tmp.setTerm(trm);
      return tmp;
    }
    else {
