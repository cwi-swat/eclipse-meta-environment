 ...
 * @see DotNodeLayout.java for how this information will later be used to
...
public class DotAdapter extends Graph {
    ...
    /**
     * Run the Dot layout algorithm and store the results as attributes in the
     * graph table. These attributes can later be used by a prefuse layout
     * algorithm.
     * 
     * @see DotNodeLayout and
     * @see DotLabelLayout for details. This method assumes you have added nodes
     *      and edges using the
     * @method addNode() and
     * @method addEdge() methods.
     * 
     */
    ...
    private static class Patterns {
        /*
         * graph scale width height node name x y width height label style shape
         * color fillcolor edge tail head n x1 y1 .. xn yn [label xl yl] style
         * color stop
         */
        ...
        try {
            do {
                ...
                if (line != null) {
                    ...
                    if (m.matches()) {
                        parseNode(m.group(1), m.group(2), m.group(3), m
                                .group(4), m.group(5));
                        continue;
                    }
     ...
     * 
     * @param b
     *            PrintStream to output the graph to
     */
